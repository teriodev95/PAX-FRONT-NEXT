                  ...
                  {courseData.message.curso.course.modules.map(
                    (module, moduleIndex) => (
                      <div key={moduleIndex} className="mb-6">
                        <h4 className="text-xs md:text-sm font-medium text-gray-300 mb-3 px-2">
                          {module.module_title}
                        </h4>
                        ...
                        <div className="flex-1">
                          <div
                            className={`font-medium text-xs md:text-sm ${
                              showQuiz ? "text-gray-900" : "text-white"
                            }`}
                          >
                            Quiz: {quiz?.title}
                          </div>
                          <div
                            className={`text-xs ${
                              showQuiz ? "text-gray-700" : "text-gray-400"
                            }`}
                          >
                            Evaluación final
                          </div>
